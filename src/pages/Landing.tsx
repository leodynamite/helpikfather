  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-4 pt-10 pb-16">
        ...
        <section id="features" className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-700">
            <ul className="space-y-1">
              <li>• Создание, редактирование и удаление заказов с основными полями.</li>
              <li>• Статусы заказов: новый, заказан, получен, выполнен, отменён.</li>
              <li>• Учёт суммы по каждому заказу и общей суммы по дню.</li>
            </ul>
            <ul className="space-y-1">
              ...
              <li>• Двойной печатный бланк (клиент + магазин) с настройкой шапки.</li>
            </ul>
            <ul className="space-y-1">
              <li>• Экспорт отфильтрованных заказов в Excel (CSV) для отчётности.</li>
              <li>• Личный кабинет настроек магазина (название, адрес, телефон, исполнитель).</li>
              <li>• Разделение данных по пользователям через Supabase Auth + RLS.</li>
            </ul>
          </div>
        </section>
        ...
        <section id="plans" className="border-t border-gray-200 pt-6 text-sm text-gray-700 mb-8">
          <h2 className="text-base font-semibold mb-2">Планы развития (для будущего SaaS)</h2>
          <p className="mb-2">
            Текущий PartsDesk — уже рабочий стол заказов. Далее его можно развивать в полноценный сервис для продажи
            подписок:
          </p>
          <ul className="text-sm text-gray-700 space-y-1 mb-3">
            <li>• Несколько пользователей в одном магазине (доступы для продавцов и владельца).</li>
            <li>• Отчёты по дням и месяцам: выручка, количество заказов, маржа.</li>
            <li>• История клиента по телефону с быстрым повтором любого заказа.</li>
            <li>• Напоминания по заказам (смс/телеграм при поступлении запчастей).</li>
            <li>• Тарифы: базовый для одного стола, расширенный для сети точек.</li>
          </ul>
          <p className="text-xs text-gray-500">
            Архитектура уже разделена на аутентификацию, базу заказов и настройки магазина, так что добавление тарифов
            и ролей пользователей будет естественным следующим шагом.
          </p>
        </section>

        <section id="privacy" className="border-t border-gray-200 pt-6 text-sm text-gray-700">
          <h2 className="text-base font-semibold mb-2">Политика конфиденциальности (кратко)</h2>
          <p className="mb-2">
            PartsDesk хранит только данные, необходимые для работы столa заказов: учетные записи пользователей,
            заказы и настройки магазина. Все данные хранятся в Supabase (PostgreSQL) с включённой политикой
            построчной безопасности (RLS) — каждый пользователь видит только свои заказы и свои настройки.
          </p>
          <ul className="text-xs text-gray-600 space-y-1 mb-2">
            <li>• Персональные данные (email, ФИО, телефон) используются только для работы сервиса.</li>
            <li>• Данные не передаются третьим лицам, кроме инфраструктурных провайдеров (Supabase, Vercel).</li>
            <li>• Пользователь может в любой момент удалить свои заказы и настройки через интерфейс (после добавления соответствующих функций).</li>
            <li>• Доступ к данным защищён логином и паролем; соединение осуществляется по HTTPS.</li>
          </ul>
          <p className="text-xs text-gray-500">
            Полная версия политики конфиденциальности может быть оформлена отдельной страницей и дополнена юридическими
            формулировками при запуске платных тарифов.
          </p>
        </section>
      </main>
    </div>
